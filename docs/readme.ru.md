0# i18n - Простая C++ библиотека для интернационализации

> Создана *исключительно* в целях изучения C++.

Легковесная библиотека, позволяющая хранить файлы переводов
и получать локализованные строки во время выполнения.
